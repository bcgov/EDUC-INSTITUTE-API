...
public interface IndependentAuthorityAPIEndpoint {
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "CREATED"), @ApiResponse(responseCode = "400", description = "BAD REQUEST")})
  @Tag(name = "Endpoint to get independent authority contact entity.", description = "Endpoint to get independent authority contact entity.")
  ...
  @PreAuthorize("hasAuthority('SCOPE_WRITE_INDEPENDENT_AUTHORITY_CONTACT')")
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "CREATED"), @ApiResponse(responseCode = "400", description = "BAD REQUEST")})
  @Tag(name = "Endpoint to update independent authority contact entity.", description = "Endpoint to update independent authority contact entity.")
  @Schema(name = "Contact", implementation = Contact.class)
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "CREATED"), @ApiResponse(responseCode = "400", description = "BAD REQUEST")})
  @Tag(name = "Endpoint to get independent authority address entity.", description = "Endpoint to get independent authority address entity.")
  ...
  @PreAuthorize("hasAuthority('SCOPE_WRITE_INDEPENDENT_AUTHORITY_ADDRESS')")
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "CREATED"), @ApiResponse(responseCode = "400", description = "BAD REQUEST")})
  @Tag(name = "Endpoint to update independent authority address entity.", description = "Endpoint to update independent authority address entity.")
  @Schema(name = "Address", implementation = Address.class)
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "CREATED"), @ApiResponse(responseCode = "400", description = "BAD REQUEST")})
  @Tag(name = "Endpoint to get independent authority note entity.", description = "Endpoint to get independent authority note entity.")
  ...
  @PreAuthorize("hasAuthority('SCOPE_WRITE_INDEPENDENT_AUTHORITY_NOTE')")
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "CREATED"), @ApiResponse(responseCode = "400", description = "BAD REQUEST")})
  @Tag(name = "Endpoint to update independentAuthority note entity.", description = "Endpoint to update independentAuthority note entity.")
  @Schema(name = "Note", implementation = Note.class)
