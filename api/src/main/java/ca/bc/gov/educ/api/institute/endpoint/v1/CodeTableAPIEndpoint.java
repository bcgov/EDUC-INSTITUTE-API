...
public interface CodeTableAPIEndpoint {
  ...
  @Tag(name = "Institute Codes", description = "Endpoint to get all country codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all province codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all district region codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all contact type codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all authority type codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all authority group codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all address type codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all neighborhood learning type codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all school facility type codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all school category codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all school organization codes.")
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
  @Transactional(readOnly = true)
  @Tag(name = "Institute Codes", description = "Endpoint to get all school grade codes.")
