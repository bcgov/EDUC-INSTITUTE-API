...
@Mapper(uses = {UUIDMapper.class, LocalDateTimeMapper.class, StringMapper.class, DistrictContactMapper.class, SchoolGradeMapper.class, NeighborhoodLearningMapper.class})
