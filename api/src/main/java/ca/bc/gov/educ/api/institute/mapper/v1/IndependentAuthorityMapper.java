...
@Mapper(uses = {UUIDMapper.class, LocalDateTimeMapper.class, StringMapper.class, AuthorityContactMapper.class, SchoolGradeMapper.class, NeighborhoodLearningMapper.class, NoteMapper.class})
