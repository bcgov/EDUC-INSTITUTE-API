...
CREATE INDEX INSTITUTE_EVENT_EVENT_STATUS_IDX ON INSTITUTE_EVENT (EVENT_STATUS) TABLESPACE API_INSTITUTE_IDX;
CREATE INDEX INSTITUTE_EVENT_SAGA_ID_IDX ON INSTITUTE_EVENT (SAGA_ID) TABLESPACE API_INSTITUTE_IDX;
CREATE INDEX INSTITUTE_EVENT_EVENT_TYPE_IDX ON INSTITUTE_EVENT (EVENT_TYPE) TABLESPACE API_INSTITUTE_IDX;
