...
(
    DISTRICT_ADDRESS_ID                 UUID NOT NULL,
    DISTRICT_ID                         UUID NOT NULL,
    ...
    UPDATE_USER                         VARCHAR(32)         NOT NULL,
    UPDATE_DATE                         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT DISTRICT_ADDRESS_ID_PK PRIMARY KEY (DISTRICT_ADDRESS_ID)
);

CREATE TABLE SCHOOL_ADDRESS
(
    SCHOOL_ADDRESS_ID                 UUID NOT NULL,
    SCHOOL_ID                         UUID NOT NULL,
    ADDRESS_LINE_1                      VARCHAR(255) NOT NULL,
    ADDRESS_LINE_2                      VARCHAR(255),
    CITY                                VARCHAR(255) NOT NULL,
    ...
    UPDATE_USER                         VARCHAR(32)         NOT NULL,
    UPDATE_DATE                         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT SCHOOL_ADDRESS_ID_PK PRIMARY KEY (SCHOOL_ADDRESS_ID)
);

CREATE TABLE AUTHORITY_ADDRESS
(
    INDEPENDENT_AUTHORITY_ID_ADDRESS_ID                 UUID NOT NULL,
    INDEPENDENT_AUTHORITY_ID                         UUID NOT NULL,
    ADDRESS_LINE_1                      VARCHAR(255) NOT NULL,
    ADDRESS_LINE_2                      VARCHAR(255),
    CITY                                VARCHAR(255) NOT NULL,
    ...
    UPDATE_USER                         VARCHAR(32)         NOT NULL,
    UPDATE_DATE                         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT AUTHORITY_ADDRESS_ID_PK PRIMARY KEY (INDEPENDENT_AUTHORITY_ID_ADDRESS_ID)
);

CREATE TABLE DISTRICT_ADDRESS_HISTORY
(
    DISTRICT_ADDRESS_HISTORY_ID                  UUID NOT NULL,
    DISTRICT_HISTORY_ID                         UUID NOT NULL,
    DISTRICT_ID                         UUID NOT NULL,
    ADDRESS_LINE_1                      VARCHAR(255) NOT NULL,
    ADDRESS_LINE_2                      VARCHAR(255),
    ...
    UPDATE_USER                         VARCHAR(32)         NOT NULL,
    UPDATE_DATE                         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT DISTRICT_ADDRESS_HISTORY_ID_PK PRIMARY KEY (DISTRICT_ADDRESS_HISTORY_ID)
);

CREATE TABLE SCHOOL_ADDRESS_HISTORY
(
    SCHOOL_ADDRESS_HISTORY_ID                  UUID NOT NULL,
    SCHOOL_HISTORY_ID                         UUID NOT NULL,
    SCHOOL_ID                         UUID NOT NULL,
    ADDRESS_LINE_1                      VARCHAR(255) NOT NULL,
    ADDRESS_LINE_2                      VARCHAR(255),
    ...
    UPDATE_USER                         VARCHAR(32)         NOT NULL,
    UPDATE_DATE                         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT SCHOOL_ADDRESS_HISTORY_ID_PK PRIMARY KEY (SCHOOL_ADDRESS_HISTORY_ID)
);

CREATE TABLE AUTHORITY_ADDRESS_HISTORY
(
    INDEPENDENT_AUTHORITY_ADDRESS_HISTORY_ID                  UUID NOT NULL,
    INDEPENDENT_AUTHORITY_HISTORY_ID                         UUID NOT NULL,
    INDEPENDENT_AUTHORITY_ID                         UUID NOT NULL,
    ADDRESS_LINE_1                      VARCHAR(255) NOT NULL,
    ADDRESS_LINE_2                      VARCHAR(255),
    ...
    UPDATE_USER                         VARCHAR(32)         NOT NULL,
    UPDATE_DATE                         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT AUTHORITY_ADDRESS_HISTORY_ID_PK PRIMARY KEY (INDEPENDENT_AUTHORITY_ADDRESS_HISTORY_ID)
);
...
CREATE TABLE SCHOOL_REPORTING_REQUIREMENT_CODE
(
    SCHOOL_REPORTING_REQUIREMENT_CODE VARCHAR(10) NOT NULL,
    LABEL VARCHAR(30) NOT NULL,
    DESCRIPTION VARCHAR(255) NOT NULL,
...
ALTER TABLE SCHOOL
    ADD CONSTRAINT SCHOOL_REPORTING_REQUIREMENT_CODE_FK FOREIGN KEY (SCHOOL_REPORTING_REQUIREMENT_CODE) REFERENCES SCHOOL_REPORTING_REQUIREMENT_CODE (SCHOOL_REPORTING_REQUIREMENT_CODE);
...
ALTER TABLE SCHOOL_HISTORY
    ADD CONSTRAINT SCHOOL_HISTORY_REPORTING_REQUIREMENT_CODE_FK FOREIGN KEY (SCHOOL_REPORTING_REQUIREMENT_CODE) REFERENCES SCHOOL_REPORTING_REQUIREMENT_CODE (SCHOOL_REPORTING_REQUIREMENT_CODE);
ALTER TABLE SCHOOL_HISTORY
...
ALTER TABLE AUTHORITY_ADDRESS
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_ADDRESS_TYPE_CODE FOREIGN KEY (ADDRESS_TYPE_CODE) REFERENCES ADDRESS_TYPE_CODE (ADDRESS_TYPE_CODE);
ALTER TABLE AUTHORITY_ADDRESS
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_PROVINCE_CODE FOREIGN KEY (PROVINCE_CODE) REFERENCES PROVINCE_CODE (PROVINCE_CODE);
ALTER TABLE AUTHORITY_ADDRESS
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_COUNTRY_CODE FOREIGN KEY (COUNTRY_CODE) REFERENCES COUNTRY_CODE (COUNTRY_CODE);
ALTER TABLE AUTHORITY_ADDRESS
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_AUTHORITY_ID FOREIGN KEY (INDEPENDENT_AUTHORITY_ID) REFERENCES INDEPENDENT_AUTHORITY (INDEPENDENT_AUTHORITY_ID);
...
ALTER TABLE DISTRICT_ADDRESS_HISTORY
    ADD CONSTRAINT FK_DISTRICT_ADDRESS_HISTORY_DISTRICT_ID FOREIGN KEY (DISTRICT_ID) REFERENCES DISTRICT (DISTRICT_ID);
...
ALTER TABLE SCHOOL_ADDRESS_HISTORY
    ADD CONSTRAINT FK_SCHOOL_ADDRESS_HISTORY_SCHOOL_ID FOREIGN KEY (SCHOOL_ID) REFERENCES SCHOOL (SCHOOL_ID);

ALTER TABLE AUTHORITY_ADDRESS_HISTORY
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_HISTORY_ADDRESS_TYPE_CODE FOREIGN KEY (ADDRESS_TYPE_CODE) REFERENCES ADDRESS_TYPE_CODE (ADDRESS_TYPE_CODE);
ALTER TABLE AUTHORITY_ADDRESS_HISTORY
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_HISTORY_PROVINCE_CODE FOREIGN KEY (PROVINCE_CODE) REFERENCES PROVINCE_CODE (PROVINCE_CODE);
ALTER TABLE AUTHORITY_ADDRESS_HISTORY
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_HISTORY_COUNTRY_CODE FOREIGN KEY (COUNTRY_CODE) REFERENCES COUNTRY_CODE (COUNTRY_CODE);
ALTER TABLE AUTHORITY_ADDRESS_HISTORY
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_HISTORY_AUTHORITY_ID FOREIGN KEY (INDEPENDENT_AUTHORITY_ID) REFERENCES INDEPENDENT_AUTHORITY (INDEPENDENT_AUTHORITY_ID);
