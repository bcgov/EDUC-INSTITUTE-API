...
ALTER TABLE SCHOOL
    ADD CONSTRAINT FK_SCHOOL_SCHOOL_CATEGORY_CODE FOREIGN KEY (SCHOOL_CATEGORY_CODE) REFERENCES SCHOOL_CATEGORY_CODE (SCHOOL_ORGANIZATION_CODE);
ALTER TABLE SCHOOL
...
ALTER TABLE SCHOOL_HISTORY
    ADD CONSTRAINT FK_SCHOOL_HISTORY_SCHOOL_CATEGORY_CODE FOREIGN KEY (SCHOOL_CATEGORY_CODE) REFERENCES SCHOOL_CATEGORY_CODE (SCHOOL_ORGANIZATION_CODE);
ALTER TABLE SCHOOL_HISTORY
