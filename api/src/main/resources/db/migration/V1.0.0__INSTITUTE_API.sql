...
(
    AUTHORITY_ADDRESS_HISTORY_ID                  UUID NOT NULL,
    AUTHORITY_HISTORY_ID                         UUID NOT NULL,
    ...
    UPDATE_USER                         VARCHAR(32)         NOT NULL,
    UPDATE_DATE                         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT AUTHORITY_ADDRESS_HISTORY_ID_PK PRIMARY KEY (AUTHORITY_ADDRESS_HISTORY_ID)
);
...
ALTER TABLE AUTHORITY_ADDRESS
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_AUTHORITY_ID FOREIGN KEY (AUTHORITY_ID) REFERENCES INDEPENDENT_AUTHORITY (INDEPENDENT_AUTHORITY_ID);
...
ALTER TABLE AUTHORITY_ADDRESS_HISTORY
    ADD CONSTRAINT FK_AUTHORITY_ADDRESS_HISTORY_AUTHORITY_ID FOREIGN KEY (AUTHORITY_ID) REFERENCES INDEPENDENT_AUTHORITY (INDEPENDENT_AUTHORITY_ID);
