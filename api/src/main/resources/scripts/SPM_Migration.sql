...
SELECT
    ...
    (SELECT addr.ADDRESS_ID from ADDRESS addr WHERE addr.ADDRESS_TYPE_CODE = 'MAILING' AND addr.SCHOOL_ID = (SELECT schl.SCHOOL_ID from SCHOOL schl WHERE schl_mast.SCHLNO = schl.SCHOOL_NUMBER AND schl_mast.DISTNO = (SELECT dist.DISTRICT_NUMBER from DISTRICT dist WHERE schl.DISTRICT_ID = dist.DISTRICT_ID))) as ADDRESS_ID,
    (SELECT schl.SCHOOL_ID from SCHOOL schl WHERE schl_mast.SCHLNO = schl.SCHOOL_NUMBER AND schl_mast.DISTNO = (SELECT dist.DISTRICT_NUMBER from DISTRICT dist WHERE schl.DISTRICT_ID = dist.DISTRICT_ID)) as SCHOOL_ID,
    (CAST(NULL as VARCHAR2(100))) as DISTRICT_ID,
    (CAST(NULL as VARCHAR2(100))) as INDEPENDENT_AUTHORITY_ID,
    TRIM(schl_mast.SC_ADDRESS_LINE_1) as ADDRESS_LINE_1,
...
SELECT
    LOWER(REGEXP_REPLACE(dbms_crypto.randombytes(16), '(.{8})(.{4})(.{4})(.{4})(.{12})', '\1-\2-\3-\4-\5')) as ADDRESS_HISTORY_ID,
    (SELECT addr.ADDRESS_ID from ADDRESS addr WHERE addr.ADDRESS_TYPE_CODE = 'PHYSICAL' AND addr.SCHOOL_ID = (SELECT schl.SCHOOL_ID from SCHOOL schl WHERE schl_mast.SCHLNO = schl.SCHOOL_NUMBER AND schl_mast.DISTNO = (SELECT dist.DISTRICT_NUMBER from DISTRICT dist WHERE schl.DISTRICT_ID = dist.DISTRICT_ID))) as ADDRESS_ID,
    (SELECT schl.SCHOOL_ID from SCHOOL schl WHERE schl_mast.SCHLNO = schl.SCHOOL_NUMBER AND schl_mast.DISTNO = (SELECT dist.DISTRICT_NUMBER from DISTRICT dist WHERE schl.DISTRICT_ID = dist.DISTRICT_ID)) as SCHOOL_ID,
    (CAST(NULL as VARCHAR2(100))) as DISTRICT_ID,
    (CAST(NULL as VARCHAR2(100))) as INDEPENDENT_AUTHORITY_ID,
    TRIM(schl_mast.PHYS_ADDRESS_LINE_1) as ADDRESS_LINE_1,
...
SELECT
    LOWER(REGEXP_REPLACE(dbms_crypto.randombytes(16), '(.{8})(.{4})(.{4})(.{4})(.{12})', '\1-\2-\3-\4-\5')) as ADDRESS_HISTORY_ID,
    (SELECT addr.ADDRESS_ID from ADDRESS addr WHERE addr.ADDRESS_TYPE_CODE = 'MAILING' AND addr.DISTRICT_ID = (SELECT dist.DISTRICT_ID from DISTRICT dist WHERE dist_mast.DISTNO = dist.DISTRICT_NUMBER)) as ADDRESS_ID,
    (CAST(NULL as VARCHAR2(100))) as SCHOOL_ID,
    (SELECT dist.DISTRICT_ID from DISTRICT dist WHERE dist_mast.DISTNO = dist.DISTRICT_NUMBER) as DISTRICT_ID,
    (CAST(NULL as VARCHAR2(100))) as INDEPENDENT_AUTHORITY_ID,
    TRIM(dist_mast.MAIL_ADDRESS_LINE_1) as ADDRESS_LINE_1,
...
SELECT
    LOWER(REGEXP_REPLACE(dbms_crypto.randombytes(16), '(.{8})(.{4})(.{4})(.{4})(.{12})', '\1-\2-\3-\4-\5')) as ADDRESS_HISTORY_ID,
    (SELECT addr.ADDRESS_ID from ADDRESS addr WHERE addr.ADDRESS_TYPE_CODE = 'PHYSICAL' AND addr.DISTRICT_ID = (SELECT dist.DISTRICT_ID from DISTRICT dist WHERE dist_mast.DISTNO = dist.DISTRICT_NUMBER)) as ADDRESS_ID,
    (CAST(NULL as VARCHAR2(100))) as SCHOOL_ID,
    (SELECT dist.DISTRICT_ID from DISTRICT dist WHERE dist_mast.DISTNO = dist.DISTRICT_NUMBER) as DISTRICT_ID,
    (CAST(NULL as VARCHAR2(100))) as INDEPENDENT_AUTHORITY_ID,
    TRIM(dist_mast.PHYS_ADDRESS_LINE_1) as ADDRESS_LINE_1,
...
SELECT
    LOWER(REGEXP_REPLACE(dbms_crypto.randombytes(16), '(.{8})(.{4})(.{4})(.{4})(.{12})', '\1-\2-\3-\4-\5')) as ADDRESS_HISTORY_ID,
    (SELECT addr.ADDRESS_ID from ADDRESS addr WHERE addr.ADDRESS_TYPE_CODE = 'MAILING' AND addr.INDEPENDENT_AUTHORITY_ID = (SELECT auth.INDEPENDENT_AUTHORITY_ID from INDEPENDENT_AUTHORITY auth WHERE auth_mast.AUTH_NUMBER = auth.AUTHORITY_NUMBER)) as ADDRESS_ID,
    (CAST(NULL as VARCHAR2(100))) as SCHOOL_ID,
    (CAST(NULL as VARCHAR2(100))) as DISTRICT_ID,
    (SELECT auth.INDEPENDENT_AUTHORITY_ID from INDEPENDENT_AUTHORITY auth WHERE auth_mast.AUTH_NUMBER = auth.AUTHORITY_NUMBER) as INDEPENDENT_AUTHORITY_ID,
    TRIM(auth_mast.ADDRESS_LINE_1) as ADDRESS_LINE_1,
